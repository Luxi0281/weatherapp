...
import com.example.luxi.weatherapp.data.Forecast
import com.example.luxi.weatherapp.data.ForecastResult
...
class ForecastDataMapper {
    ...
    fun convertFromDataModel(forecast: ForecastResult): ForecastList = ForecastList(forecast.city.name, forecast.city.country,
